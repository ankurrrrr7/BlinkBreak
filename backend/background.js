...
chrome.alarms.onAlarm.addListener((alarm) => {
    if (alarm.name === 'blinkReminder') {
        showNotification("Time to Blink!', 'Don't forget to blink your eyes to protect them!'");
    }
});
...
function startNotifications(time) {
    ...
    showNotification('Blink Reminder Started', 'You will be reminded to blink every ' + time + ' minutes.');
}
